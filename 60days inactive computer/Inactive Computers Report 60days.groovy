...
emailSubject = "SunPharma - AD Computers - Accounts Status Report - Disabled & Non-Reporting (60 Days)- "
...
<ul>
<li>60 Days Disabled Computers Account</li>
<li>60 Days Enabled but Not Reporting Computers Account</li>
</ul>
...
step("getDisabledReport", StepType.ONFUNCTION) {
    ...
    Entity.GetDisabledComputers60days(path: processMap.AttachmentPath, Domains: processMap.DomainNames, ioutput: "getDisabledReport_output");
}
...
step("getEnabledReport", StepType.ONFUNCTION) {
    ...
    Entity.GetEnabledComputersNotReporting60Days(path: processMap.AttachmentPath, Domains: processMap.DomainNames, ioutput: "getEnabledReport_output");
}
...
.to({ processMap.getEnabledReport_output.returnCode == 0 && processMap.getEnabledReport_output.outputStream.contains("No Enabled computers have failed to report for 60") }, "Get File on Ignio")
...
step("ConnectivityIssue", StepType.ONIGNIO) {
    Mailbody = """Dear User,<br><br> Connectivity issue found in the AD Domain server while fetching the AD Computers Status Report. <br>Kindly, look into it and generate the report manually. <br><br>Thank You,<br>Team Ignio <br><br><b>Note: This is an automatically generated mail. Please do not reply.</b>""";
    ...
    if (hasDisabledReport && hasEnabledReport){
        ...
        <body>
            <div class="container">
                ...
                <ul>
                    <li><strong>Disabled Computers Report more than 60 Days</strong></li>
                    <li><strong>Enabled Computers but Not Reporting since 60 Days</strong></li>
                </ul>
                ...
                <div class="table-container">
                    <table>
                        <tr>
                            <th>Domains</th>
                            <th>Disabled Computers Report more than 60 Days</th>
                            <th>Enabled Computers but Not Reporting since 60 Days</th>
                        </tr>
